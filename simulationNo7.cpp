...
int main(void)
{
	...
	cout<< "\n\t The Number of Class is 7 (Type 1 : 1, Type 2 : 6) "<<endl;
	...
	for(int i=0; i<No_Simulation; i++)
	{
		...
		if((Class1.Sw<=Class2.Sw)&&(Class1.Sw<=Class3.Sw)&&(Class1.Sw<=Class4.Sw)&&(Class1.Sw<=Class5.Sw)&&(Class1.Sw<=Class6.Sw))
			Select_sw = Class1.Sw;
		else if((Class2.Sw<=Class1.Sw)&&(Class2.Sw<=Class3.Sw)&&(Class2.Sw<=Class4.Sw)&&(Class2.Sw<=Class5.Sw)&&(Class2.Sw<=Class6.Sw))
			Select_sw = Class2.Sw;
		else if((Class3.Sw<=Class1.Sw)&&(Class3.Sw<=Class2.Sw)&&(Class3.Sw<=Class4.Sw)&&(Class3.Sw<=Class5.Sw)&&(Class3.Sw<=Class6.Sw))
			Select_sw = Class3.Sw;
		else if((Class4.Sw<=Class1.Sw)&&(Class4.Sw<=Class2.Sw)&&(Class4.Sw<=Class3.Sw)&&(Class4.Sw<=Class5.Sw)&&(Class4.Sw<=Class6.Sw))
			Select_sw = Class4.Sw;
		else if((Class5.Sw<=Class1.Sw)&&(Class5.Sw<=Class2.Sw)&&(Class5.Sw<=Class3.Sw)&&(Class5.Sw<=Class4.Sw)&&(Class5.Sw<=Class6.Sw))
			Select_sw = Class5.Sw;
		else
			Select_sw = Class6.Sw;

		if((Class1.Lw>=Class2.Lw)&&(Class1.Lw>=Class3.Lw)&&(Class1.Lw>=Class4.Lw)&&(Class1.Lw>=Class5.Lw)&&(Class1.Lw>=Class6.Lw))
			Select_lw = Class1.Lw;
		else if((Class2.Lw>=Class1.Lw)&&(Class2.Lw>=Class3.Lw)&&(Class2.Lw>=Class4.Lw)&&(Class2.Lw>=Class5.Lw)&&(Class2.Lw>=Class6.Lw))
			Select_lw = Class2.Lw;
		else if((Class3.Lw>=Class1.Lw)&&(Class3.Lw>=Class2.Lw)&&(Class3.Lw>=Class4.Lw)&&(Class3.Lw>=Class5.Lw)&&(Class3.Lw>=Class6.Lw))
			Select_lw = Class3.Lw;
		else if((Class4.Lw>=Class1.Lw)&&(Class4.Lw>=Class2.Lw)&&(Class4.Lw>=Class3.Lw)&&(Class4.Lw>=Class5.Lw)&&(Class4.Lw>=Class6.Lw))
			Select_lw = Class4.Lw;
		else if((Class5.Lw>=Class1.Lw)&&(Class5.Lw>=Class2.Lw)&&(Class5.Lw>=Class3.Lw)&&(Class5.Lw>=Class4.Lw)&&(Class5.Lw>=Class6.Lw))
			Select_lw = Class5.Lw;
		else
			Select_lw = Class6.Lw;
			...
			for(int j=0; j<Class2.Sw; j++)
			{
				...
				for(int k=0; k<Class3.Sw; k++)
				{
					...
					for(int l=0; l<Class4.Sw; l++)
					{
						...
						{
							Class5.Shift(n);
							for(int m=0; m<Class6.Sw; m++)
							{
								Class6.Shift(m);
								for(int p=0; p<Arr_size; p++)
								{
									if((Class1.arr[p]==1)||(Class2.arr[p]==1)||(Class3.arr[p]==1)||(Class4.arr[p]==1)||(Class5.arr[p]==1)||(Class6.arr[p]==1))
									{
										eMUIArr[p] = 1;
									}
									else if((Class1.arr[p]==0)||(Class2.arr[p]==0)||(Class3.arr[p]==0)||(Class4.arr[p]==0)||(Class5.arr[p]==0)||(Class6.arr[p]==0))
									{
										eMUIArr[p] = 0;
									}
									int Sleepcount = 0;
		...
		Class6.Shift(StartFrame6);

		for(int i=0; i<Arr_size; i++)
		{
			if((Class1.arr[i]==1)||(Class2.arr[i]==1)||(Class3.arr[i]==1)||(Class4.arr[i]==1)||(Class5.arr[i]==1)||(Class6.arr[i]==1))
			{
				eMUIArr[i] = 1;
			}
			else if((Class1.arr[i]==0)&&(Class2.arr[i]==0)&&(Class3.arr[i]==0)&&(Class4.arr[i]==0)&&(Class5.arr[i]==0)&&(Class6.arr[i]==0))
			{
				eMUIArr[i] = 0;
			}
		}
		...
		for(int i=0; i<Arr_size; i++)
		{
			if((Class0.arr[i]==1)||(Class1.arr[i]==1)||(Class2.arr[i]==1)||(Class3.arr[i]==1)||(Class4.arr[i]==1)||(Class5.arr[i]==1)||(Class6.arr[i]==1))
			{
				SumArr[i] = 1;
			}
			else if((Class0.arr[i]==0)&&(Class1.arr[i]==0)&&(Class2.arr[i]==0)&&(Class3.arr[i]==0)&&(Class4.arr[i]==0)&&(Class5.arr[i]==0)&&(Class6.arr[i]==0))
			{
				SumArr[i] = 0;
			}
		}
