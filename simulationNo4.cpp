...
int main(void)
{
	...
	cout<< "\n\t The Number of Class is 4 (Type 1 : 1, Type 2 : 3) "<<endl;
	...
	for(int i=0; i<No_Simulation; i++)
	{
		...
		if((Class1.Sw<=Class2.Sw)&&(Class1.Sw<=Class3.Sw))
			Select_sw = Class1.Sw;
		else if((Class2.Sw<=Class1.Sw)&&(Class2.Sw<=Class3.Sw))
			Select_sw = Class2.Sw;
		else
			Select_sw = Class3.Sw;

		if((Class1.Lw>=Class2.Lw)&&(Class1.Lw>=Class3.Lw))
			Select_lw = Class1.Lw;
		else if((Class2.Lw>=Class1.Lw)&&(Class2.Lw>=Class3.Lw))
			Select_lw = Class2.Lw;
		else
			Select_lw = Class3.Lw;
		...
		for(int i=0; i<Class1.Sw; i++)
		{
			...
			for(int j=0; j<Class2.Sw; j++)
			{
				...
				for(int k=0; k<Class3.Sw; k++)
				{
					...
					{
						if((Class1.arr[l]==1)||(Class2.arr[l]==1)||(Class3.arr[l]==1))
						{
							eMUIArr[l] = 1;
						}
						else if((Class1.arr[l]==0)||(Class2.arr[l]==0)||(Class3.arr[l]==0))
						{
							eMUIArr[l] = 0;
						}
						int Sleepcount = 0;
		...
		for(int i=0; i<Arr_size; i++)
		{
			if((Class1.arr[i]==1)||(Class2.arr[i]==1)||(Class3.arr[i]==1))
			{
				eMUIArr[i] = 1;
			}
			else if((Class1.arr[i]==0)&&(Class2.arr[i]==0)&&(Class3.arr[i]==0))
			{
				eMUIArr[i] = 0;
			}
		}
		...
		for(int i=0; i<Arr_size; i++)
		{
			if((Class0.arr[i]==1)||(Class1.arr[i]==1)||(Class2.arr[i]==1)||(Class3.arr[i]==1))
			{
				SumArr[i] = 1;
			}
			else if((Class0.arr[i]==0)&&(Class1.arr[i]==0)&&(Class2.arr[i]==0)&&(Class3.arr[i]==0))
			{
				SumArr[i] = 0;
			}
		}
